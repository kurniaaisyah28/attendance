...
function LoadDataHistori(){
    ...
    $(".load-histori").load("./module/rekap-absen-ekbm/sw-proses.php?action=data-histori&mulai="+mulai+"&selesai="+selesai+"");
}
...
$('.btn-print').click(function (e) {
    var mulai = $('.mulai').val();
    var selesai = $('.selesai').val();
    var url = "../wali-murid-print-ekbm?mulai="+mulai+"&selesai="+selesai+"";
