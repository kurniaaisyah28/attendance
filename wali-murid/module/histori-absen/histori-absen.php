...
<main class="flex-shrink-0 main has-footer s-widodo.com">
    <div class="main-container s-widodo.com">
        ...
        <div class="container mb-4 s-widodo.com">
            <h6 class="subtitle mb-3 mt-2">Daftar Kehadrian<br>
            <small>'.$data_user['nama_siswa'].'</small></h6>
            <div class="load-histori postList s-widodo.com"></div>
        </div>
    </div>
...
$query  = "SELECT absen.*, user.nisn 
    FROM absen 
    LEFT JOIN user ON absen.user_id = user.user_id 
    WHERE user.nisn = '$data_user[nisn]' AND absen_id='$id'";
