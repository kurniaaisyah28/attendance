...
function tambahAbsen($connection, $pegawai_id, $tanggal, $lokasi_id, $keterangan) {
  ...
  if (empty($error)) {
    ...
    if($connection->query($add) === false) { 
        ...
        while (strtotime($tanggal) <= strtotime($tanggal_selesai)) {
          if (!tambahAbsen($connection, $pegawai_id, $tanggal, $data_user['lokasi'], $keterangan))
          $status = '';
          break;
...
if (isset($_POST['id'])) {
  ...
  while (strtotime($tanggal) <= strtotime($tglSelesai)) {
      if (!tambahAbsen($connection, $pegawai_id, $tanggal, $dataUser['lokasi'], $keterangan)) break;
