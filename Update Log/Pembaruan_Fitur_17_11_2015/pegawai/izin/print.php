...
$query_izin ="SELECT * FROM izin_pegawai WHERE pegawai_id='".htmlentities($data_user['pegawai_id'])."' $filter";
...
$pdf->Cell(0, 3, 'Laporan Izin Tanggal '.htmlentities($_GET['mulai']??'').' s.d '.htmlentities($_GET['selesai']??'').'', 0, 1, 'L');
$pdf->Ln(5);
