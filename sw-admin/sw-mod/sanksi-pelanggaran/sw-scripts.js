...
$(".kelas").change(function () {
    ...
    $.ajax({
        type: 'POST',
        url: './sw-mod/sanksi-pelanggaran/sw-proses.php?action=dropdown',
        data: { kelas: kelas },
        cache: false,
...
function loadData() {
    $(document).ready(function () {
        ...
        table = $('.datatable').DataTable({
            ...
            ajax: {
                url: './sw-mod/sanksi-pelanggaran/sw-datatable.php',
                type: 'POST',
                data: function (d) {
    ...
    swal({
        ...
        .then((value) => {
            if (value) {
                loading();
                $.ajax({
                    url: './sw-mod/sanksi-pelanggaran/sw-proses.php?action=delete',
                    type: 'POST',
                    data: { id: id },
                    success: function (data) {
                        if (data == 'success') {
...
$(document).on('click', '.btn-download', function () {
    ...
    var from = $('.from').val();
    var to = $('.to').val();
    var url = "./sw-mod/sanksi-pelanggaran/sw-print.php?action=" + tipe + "&kelas=" + kelas +
