...
function loadData() {
    ...
    $(document).ready(function () {
        ...
        table = $('.datatable').DataTable({
            ...
            "ajax": {
                "url": "./sw-mod/template-surat/sw-datatable.php",
                "type": "POST",
                "data": {
...
function submitForm_Add() {
    ...
    $.ajax({
        type: 'POST',
        url: './sw-mod/template-surat/sw-proses.php?action=add',
        data: data,
        cache: false,
        async: false,
        beforeSend: function () {
...
$(document).on('click', '.btn-update', function () {
    ...
    $.ajax({
        type: 'POST',
        url: './sw-mod/template-surat/sw-proses.php?action=get-data-update',
        data: { id: id },
        dataType: 'json',
    ...
    swal({
        ...
        .then((value) => {
            if (value) {
                loading();
                $.ajax({
                    url: './sw-mod/template-surat/sw-proses.php?action=delete',
                    type: 'POST',
                    data: { id: id },
                    success: function (data) {
                        if (data == 'success') {
