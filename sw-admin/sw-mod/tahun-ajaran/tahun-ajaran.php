        ...
        <div class="col-md-8">
          <div class="card pb-3">
            ...
            <div class="card-header mb-2">
              <h3 class="mb-0 text-left float-left">Tahun Ajaran</h3>
            </div>';
          ...
          <div class="col-md-4">
            <div class="card ">
              <div class="card-header mb-2">
                <h3 class="mb-0 text-left float-left">Input Tahun Ajaran</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control tahun-ajaran" name="tahun_ajaran" required>
                </div>
